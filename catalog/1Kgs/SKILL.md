...
name: 1 Kings
description: >-
  Use when the user runs /1Kgs or requests this BibleMate workflow (native Grok Bot port).
---
# 1 Kings

Native Grok Bot port of the BibleMate playbook `1Kgs`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/1Kgs/SKILL.md` with `Read`.
