...
name: Summary
description: >-
  Use when the user runs /summary or requests this BibleMate workflow (native Grok Bot port).
---
# Summary

Native Grok Bot port of the BibleMate playbook `summary`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/summary/SKILL.md` with `Read`.
