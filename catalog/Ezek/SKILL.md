...
name: Ezekiel
description: >-
  Use when the user runs /Ezek or requests this BibleMate workflow (native Grok Bot port).
---
# Ezekiel

Native Grok Bot port of the BibleMate playbook `Ezek`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Ezek/SKILL.md` with `Read`.
