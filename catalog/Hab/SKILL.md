...
name: Habakkuk
description: >-
  Use when the user runs /Hab or requests this BibleMate workflow (native Grok Bot port).
---
# Habakkuk

Native Grok Bot port of the BibleMate playbook `Hab`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Hab/SKILL.md` with `Read`.
