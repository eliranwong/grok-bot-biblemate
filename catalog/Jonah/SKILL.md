...
name: Jonah
description: >-
  Use when the user runs /Jonah or requests this BibleMate workflow (native Grok Bot port).
---
# Jonah

Native Grok Bot port of the BibleMate playbook `Jonah`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Jonah/SKILL.md` with `Read`.
