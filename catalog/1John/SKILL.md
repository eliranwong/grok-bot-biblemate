...
name: 1 John
description: >-
  Use when the user runs /1John or requests this BibleMate workflow (native Grok Bot port).
---
# 1 John

Native Grok Bot port of the BibleMate playbook `1John`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/1John/SKILL.md` with `Read`.
