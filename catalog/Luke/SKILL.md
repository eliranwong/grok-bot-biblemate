...
name: Luke
description: >-
  Use when the user runs /Luke or requests this BibleMate workflow (native Grok Bot port).
---
# Luke

Native Grok Bot port of the BibleMate playbook `Luke`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Luke/SKILL.md` with `Read`.
