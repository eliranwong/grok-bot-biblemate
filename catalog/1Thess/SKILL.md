...
description: >-
  Use when the user runs /1Thess or requests this BibleMate workflow (native Grok Bot port).
---
# 1 Thessalonians

Native Grok Bot port of the BibleMate playbook `1Thess`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/1Thess/SKILL.md` with `Read`.
