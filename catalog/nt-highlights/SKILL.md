...
name: NT Highlights
description: >-
  Use when the user runs /nt-highlights or requests this BibleMate workflow (native Grok Bot port).
---
# NT Highlights

Native Grok Bot port of the BibleMate playbook `nt-highlights`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/nt-highlights/SKILL.md` with `Read`.
