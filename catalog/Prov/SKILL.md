...
name: Proverbs
description: >-
  Use when the user runs /Prov or requests this BibleMate workflow (native Grok Bot port).
---
# Proverbs

Native Grok Bot port of the BibleMate playbook `Prov`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Prov/SKILL.md` with `Read`.
