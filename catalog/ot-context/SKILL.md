...
name: OT Context
description: >-
  Use when the user runs /ot-context or requests this BibleMate workflow (native Grok Bot port).
---
# OT Context

Native Grok Bot port of the BibleMate playbook `ot-context`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/ot-context/SKILL.md` with `Read`.
