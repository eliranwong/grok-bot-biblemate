...
name: Canon
description: >-
  Use when the user runs /canon or requests this BibleMate workflow (native Grok Bot port).
---
# Canon

Native Grok Bot port of the BibleMate playbook `canon`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/canon/SKILL.md` with `Read`.
