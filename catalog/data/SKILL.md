...
name: Data
description: >-
  Use when the user runs /data or requests this BibleMate workflow (native Grok Bot port).
---
# Data

Native Grok Bot port of the BibleMate playbook `data`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/data/SKILL.md` with `Read`.
