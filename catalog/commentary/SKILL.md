...
name: Commentary
description: >-
  Use when the user runs /commentary or requests this BibleMate workflow (native Grok Bot port).
---
# Commentary

Native Grok Bot port of the BibleMate playbook `commentary`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/commentary/SKILL.md` with `Read`.
