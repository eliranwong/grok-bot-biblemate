...
name: Flow
description: >-
  Use when the user runs /flow or requests this BibleMate workflow (native Grok Bot port).
---
# Flow

Native Grok Bot port of the BibleMate playbook `flow`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/flow/SKILL.md` with `Read`.
