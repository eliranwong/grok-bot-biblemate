...
name: OT Meaning
description: >-
  Use when the user runs /ot-meaning or requests this BibleMate workflow (native Grok Bot port).
---
# OT Meaning

Native Grok Bot port of the BibleMate playbook `ot-meaning`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/ot-meaning/SKILL.md` with `Read`.
