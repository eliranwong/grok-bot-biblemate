...
name: Genesis
description: >-
  Use when the user runs /Gen or requests this BibleMate workflow (native Grok Bot port).
---
# Genesis

Native Grok Bot port of the BibleMate playbook `Gen`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Gen/SKILL.md` with `Read`.
