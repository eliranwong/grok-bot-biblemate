...
name: Quotes
description: >-
  Use when the user runs /quotes or requests this BibleMate workflow (native Grok Bot port).
---
# Quotes

Native Grok Bot port of the BibleMate playbook `quotes`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/quotes/SKILL.md` with `Read`.
