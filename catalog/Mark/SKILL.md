...
name: Mark
description: >-
  Use when the user runs /Mark or requests this BibleMate workflow (native Grok Bot port).
---
# Mark

Native Grok Bot port of the BibleMate playbook `Mark`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Mark/SKILL.md` with `Read`.
