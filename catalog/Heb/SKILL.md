...
name: Hebrews
description: >-
  Use when the user runs /Heb or requests this BibleMate workflow (native Grok Bot port).
---
# Hebrews

Native Grok Bot port of the BibleMate playbook `Heb`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Heb/SKILL.md` with `Read`.
