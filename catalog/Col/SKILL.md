...
name: Colossians
description: >-
  Use when the user runs /Col or requests this BibleMate workflow (native Grok Bot port).
---
# Colossians

Native Grok Bot port of the BibleMate playbook `Col`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Col/SKILL.md` with `Read`.
