...
name: Ruth
description: >-
  Use when the user runs /Ruth or requests this BibleMate workflow (native Grok Bot port).
---
# Ruth

Native Grok Bot port of the BibleMate playbook `Ruth`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Ruth/SKILL.md` with `Read`.
