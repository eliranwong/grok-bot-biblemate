...
name: 1 Corinthians
description: >-
  Use when the user runs /1Cor or requests this BibleMate workflow (native Grok Bot port).
---
# 1 Corinthians

Native Grok Bot port of the BibleMate playbook `1Cor`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/1Cor/SKILL.md` with `Read`.
