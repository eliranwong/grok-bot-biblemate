...
name: 1 Samuel
description: >-
  Use when the user runs /1Sam or requests this BibleMate workflow (native Grok Bot port).
---
# 1 Samuel

Native Grok Bot port of the BibleMate playbook `1Sam`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/1Sam/SKILL.md` with `Read`.
