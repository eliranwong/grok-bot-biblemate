...
description: >-
  Use when the user runs /translate-hebrew or requests this BibleMate workflow (native Grok Bot port).
---
# Translate Hebrew

Native Grok Bot port of the BibleMate playbook `translate-hebrew`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/translate-hebrew/SKILL.md` with `Read`.
