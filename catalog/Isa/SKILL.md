...
name: Isaiah
description: >-
  Use when the user runs /Isa or requests this BibleMate workflow (native Grok Bot port).
---
# Isaiah

Native Grok Bot port of the BibleMate playbook `Isa`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Isa/SKILL.md` with `Read`.
