...
name: MD
description: >-
  Use when the user runs /md or requests this BibleMate workflow (native Grok Bot port).
---
# MD

Native Grok Bot port of the BibleMate playbook `md`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/md/SKILL.md` with `Read`.
