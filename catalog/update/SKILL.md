...
name: Update
description: >-
  Use when the user runs /update or requests this BibleMate workflow (native Grok Bot port).
---
# Update

Native Grok Bot port of the BibleMate playbook `update`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/update/SKILL.md` with `Read`.
