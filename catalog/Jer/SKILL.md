...
name: Jeremiah
description: >-
  Use when the user runs /Jer or requests this BibleMate workflow (native Grok Bot port).
---
# Jeremiah

Native Grok Bot port of the BibleMate playbook `Jer`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Jer/SKILL.md` with `Read`.
