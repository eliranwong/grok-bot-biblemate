...
description: >-
  Use when the user runs /biblemate-studies-cli or requests this BibleMate workflow (native Grok Bot port).
---
# BibleMate Studies CLI

Native Grok Bot port of the BibleMate playbook `biblemate-studies-cli`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/biblemate-studies-cli/SKILL.md` with `Read`.
