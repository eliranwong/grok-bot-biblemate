...
description: >-
  Use when the user runs /chapter-summary or requests this BibleMate workflow (native Grok Bot port).
---
# Chapter Summary

Native Grok Bot port of the BibleMate playbook `chapter-summary`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/chapter-summary/SKILL.md` with `Read`.
