...
name: Prayer
description: >-
  Use when the user runs /prayer or requests this BibleMate workflow (native Grok Bot port).
---
# Prayer

Native Grok Bot port of the BibleMate playbook `prayer`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/prayer/SKILL.md` with `Read`.
