...
name: Nahum
description: >-
  Use when the user runs /Nah or requests this BibleMate workflow (native Grok Bot port).
---
# Nahum

Native Grok Bot port of the BibleMate playbook `Nah`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Nah/SKILL.md` with `Read`.
