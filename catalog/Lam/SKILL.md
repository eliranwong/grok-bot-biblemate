...
name: Lamentations
description: >-
  Use when the user runs /Lam or requests this BibleMate workflow (native Grok Bot port).
---
# Lamentations

Native Grok Bot port of the BibleMate playbook `Lam`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Lam/SKILL.md` with `Read`.
