...
name: Zephaniah
description: >-
  Use when the user runs /Zeph or requests this BibleMate workflow (native Grok Bot port).
---
# Zephaniah

Native Grok Bot port of the BibleMate playbook `Zeph`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Zeph/SKILL.md` with `Read`.
