...
name: Judges
description: >-
  Use when the user runs /Judg or requests this BibleMate workflow (native Grok Bot port).
---
# Judges

Native Grok Bot port of the BibleMate playbook `Judg`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Judg/SKILL.md` with `Read`.
