...
name: Testimony
description: >-
  Use when the user runs /testimony or requests this BibleMate workflow (native Grok Bot port).
---
# Testimony

Native Grok Bot port of the BibleMate playbook `testimony`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/testimony/SKILL.md` with `Read`.
