...
name: James
description: >-
  Use when the user runs /Jas or requests this BibleMate workflow (native Grok Bot port).
---
# James

Native Grok Bot port of the BibleMate playbook `Jas`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Jas/SKILL.md` with `Read`.
