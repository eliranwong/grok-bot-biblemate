...
name: Micah
description: >-
  Use when the user runs /Mic or requests this BibleMate workflow (native Grok Bot port).
---
# Micah

Native Grok Bot port of the BibleMate playbook `Mic`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Mic/SKILL.md` with `Read`.
