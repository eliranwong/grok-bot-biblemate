...
name: Acts
description: >-
  Use when the user runs /Acts or requests this BibleMate workflow (native Grok Bot port).
---
# Acts

Native Grok Bot port of the BibleMate playbook `Acts`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Acts/SKILL.md` with `Read`.
