...
name: Job
description: >-
  Use when the user runs /Job or requests this BibleMate workflow (native Grok Bot port).
---
# Job

Native Grok Bot port of the BibleMate playbook `Job`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Job/SKILL.md` with `Read`.
