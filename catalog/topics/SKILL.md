...
name: Topics
description: >-
  Use when the user runs /topics or requests this BibleMate workflow (native Grok Bot port).
---
# Topics

Native Grok Bot port of the BibleMate playbook `topics`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/topics/SKILL.md` with `Read`.
