...
name: Philemon
description: >-
  Use when the user runs /Phlm or requests this BibleMate workflow (native Grok Bot port).
---
# Philemon

Native Grok Bot port of the BibleMate playbook `Phlm`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Phlm/SKILL.md` with `Read`.
