...
name: Online
description: >-
  Use when the user runs /online or requests this BibleMate workflow (native Grok Bot port).
---
# Online

Native Grok Bot port of the BibleMate playbook `online`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/online/SKILL.md` with `Read`.
