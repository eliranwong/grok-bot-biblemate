...
name: Ecclesiastes
description: >-
  Use when the user runs /Eccl or requests this BibleMate workflow (native Grok Bot port).
---
# Ecclesiastes

Native Grok Bot port of the BibleMate playbook `Eccl`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Eccl/SKILL.md` with `Read`.
