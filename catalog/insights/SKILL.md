...
name: Insights
description: >-
  Use when the user runs /insights or requests this BibleMate workflow (native Grok Bot port).
---
# Insights

Native Grok Bot port of the BibleMate playbook `insights`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/insights/SKILL.md` with `Read`.
