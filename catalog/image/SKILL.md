...
name: Image
description: >-
  Use when the user runs /image or requests this BibleMate workflow (native Grok Bot port).
---
# Image

Native Grok Bot port of the BibleMate playbook `image`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/image/SKILL.md` with `Read`.
