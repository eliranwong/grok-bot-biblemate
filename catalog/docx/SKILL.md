...
name: DOCX
description: >-
  Use when the user runs /docx or requests this BibleMate workflow (native Grok Bot port).
---
# DOCX

Native Grok Bot port of the BibleMate playbook `docx`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/docx/SKILL.md` with `Read`.
