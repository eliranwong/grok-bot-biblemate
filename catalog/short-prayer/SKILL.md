...
name: Short Prayer
description: >-
  Use when the user runs /short-prayer or requests this BibleMate workflow (native Grok Bot port).
---
# Short Prayer

Native Grok Bot port of the BibleMate playbook `short-prayer`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/short-prayer/SKILL.md` with `Read`.
