...
name: Keywords
description: >-
  Use when the user runs /keywords or requests this BibleMate workflow (native Grok Bot port).
---
# Keywords

Native Grok Bot port of the BibleMate playbook `keywords`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/keywords/SKILL.md` with `Read`.
