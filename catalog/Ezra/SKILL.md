...
name: Ezra
description: >-
  Use when the user runs /Ezra or requests this BibleMate workflow (native Grok Bot port).
---
# Ezra

Native Grok Bot port of the BibleMate playbook `Ezra`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Ezra/SKILL.md` with `Read`.
