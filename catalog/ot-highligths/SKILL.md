---
name: OT Highlights (legacy slug)
description: >-
  Use when the user runs /ot-highligths or requests this BibleMate workflow (native Grok Bot port).
---
# OT Highlights (legacy slug)

Native Grok Bot port of the BibleMate playbook `ot-highligths`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/ot-highligths/SKILL.md` with `Read`.
