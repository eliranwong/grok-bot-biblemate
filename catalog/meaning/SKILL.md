...
name: Meaning
description: >-
  Use when the user runs /meaning or requests this BibleMate workflow (native Grok Bot port).
---
# Meaning

Native Grok Bot port of the BibleMate playbook `meaning`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/meaning/SKILL.md` with `Read`.
