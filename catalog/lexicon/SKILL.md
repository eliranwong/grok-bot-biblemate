...
name: Lexicon
description: >-
  Use when the user runs /lexicon or requests this BibleMate workflow (native Grok Bot port).
---
# Lexicon

Native Grok Bot port of the BibleMate playbook `lexicon`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/lexicon/SKILL.md` with `Read`.
