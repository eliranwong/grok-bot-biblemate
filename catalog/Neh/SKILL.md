...
name: Nehemiah
description: >-
  Use when the user runs /Neh or requests this BibleMate workflow (native Grok Bot port).
---
# Nehemiah

Native Grok Bot port of the BibleMate playbook `Neh`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Neh/SKILL.md` with `Read`.
