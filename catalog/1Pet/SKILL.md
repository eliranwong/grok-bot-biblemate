...
name: 1 Peter
description: >-
  Use when the user runs /1Pet or requests this BibleMate workflow (native Grok Bot port).
---
# 1 Peter

Native Grok Bot port of the BibleMate playbook `1Pet`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/1Pet/SKILL.md` with `Read`.
