...
name: Daniel
description: >-
  Use when the user runs /Dan or requests this BibleMate workflow (native Grok Bot port).
---
# Daniel

Native Grok Bot port of the BibleMate playbook `Dan`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Dan/SKILL.md` with `Read`.
