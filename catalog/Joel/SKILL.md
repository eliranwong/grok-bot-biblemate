...
name: Joel
description: >-
  Use when the user runs /Joel or requests this BibleMate workflow (native Grok Bot port).
---
# Joel

Native Grok Bot port of the BibleMate playbook `Joel`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Joel/SKILL.md` with `Read`.
