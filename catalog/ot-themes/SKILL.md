...
name: OT Themes
description: >-
  Use when the user runs /ot-themes or requests this BibleMate workflow (native Grok Bot port).
---
# OT Themes

Native Grok Bot port of the BibleMate playbook `ot-themes`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/ot-themes/SKILL.md` with `Read`.
