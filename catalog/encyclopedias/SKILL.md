...
name: Encyclopedias
description: >-
  Use when the user runs /encyclopedias or requests this BibleMate workflow (native Grok Bot port).
---
# Encyclopedias

Native Grok Bot port of the BibleMate playbook `encyclopedias`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/encyclopedias/SKILL.md` with `Read`.
