...
name: Deuteronomy
description: >-
  Use when the user runs /Deut or requests this BibleMate workflow (native Grok Bot port).
---
# Deuteronomy

Native Grok Bot port of the BibleMate playbook `Deut`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Deut/SKILL.md` with `Read`.
