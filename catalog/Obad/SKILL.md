...
name: Obadiah
description: >-
  Use when the user runs /Obad or requests this BibleMate workflow (native Grok Bot port).
---
# Obadiah

Native Grok Bot port of the BibleMate playbook `Obad`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Obad/SKILL.md` with `Read`.
