...
name: 2 Kings
description: >-
  Use when the user runs /2Kgs or requests this BibleMate workflow (native Grok Bot port).
---
# 2 Kings

Native Grok Bot port of the BibleMate playbook `2Kgs`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/2Kgs/SKILL.md` with `Read`.
