...
name: Hosea
description: >-
  Use when the user runs /Hos or requests this BibleMate workflow (native Grok Bot port).
---
# Hosea

Native Grok Bot port of the BibleMate playbook `Hos`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Hos/SKILL.md` with `Read`.
