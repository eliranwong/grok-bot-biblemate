...
name: Romans
description: >-
  Use when the user runs /Rom or requests this BibleMate workflow (native Grok Bot port).
---
# Romans

Native Grok Bot port of the BibleMate playbook `Rom`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Rom/SKILL.md` with `Read`.
