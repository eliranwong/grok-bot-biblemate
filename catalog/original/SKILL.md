...
name: Original
description: >-
  Use when the user runs /original or requests this BibleMate workflow (native Grok Bot port).
---
# Original

Native Grok Bot port of the BibleMate playbook `original`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/original/SKILL.md` with `Read`.
