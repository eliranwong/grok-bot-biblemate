...
name: Parallels
description: >-
  Use when the user runs /parallels or requests this BibleMate workflow (native Grok Bot port).
---
# Parallels

Native Grok Bot port of the BibleMate playbook `parallels`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/parallels/SKILL.md` with `Read`.
