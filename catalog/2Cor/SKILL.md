...
name: 2 Corinthians
description: >-
  Use when the user runs /2Cor or requests this BibleMate workflow (native Grok Bot port).
---
# 2 Corinthians

Native Grok Bot port of the BibleMate playbook `2Cor`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/2Cor/SKILL.md` with `Read`.
