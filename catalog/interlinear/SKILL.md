...
name: Interlinear
description: >-
  Use when the user runs /interlinear or requests this BibleMate workflow (native Grok Bot port).
---
# Interlinear

Native Grok Bot port of the BibleMate playbook `interlinear`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/interlinear/SKILL.md` with `Read`.
