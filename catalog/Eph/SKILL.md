...
name: Ephesians
description: >-
  Use when the user runs /Eph or requests this BibleMate workflow (native Grok Bot port).
---
# Ephesians

Native Grok Bot port of the BibleMate playbook `Eph`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Eph/SKILL.md` with `Read`.
