...
name: Revelation
description: >-
  Use when the user runs /Rev or requests this BibleMate workflow (native Grok Bot port).
---
# Revelation

Native Grok Bot port of the BibleMate playbook `Rev`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Rev/SKILL.md` with `Read`.
