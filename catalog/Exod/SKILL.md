...
name: Exodus
description: >-
  Use when the user runs /Exod or requests this BibleMate workflow (native Grok Bot port).
---
# Exodus

Native Grok Bot port of the BibleMate playbook `Exod`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Exod/SKILL.md` with `Read`.
