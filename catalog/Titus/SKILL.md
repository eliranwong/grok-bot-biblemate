...
name: Titus
description: >-
  Use when the user runs /Titus or requests this BibleMate workflow (native Grok Bot port).
---
# Titus

Native Grok Bot port of the BibleMate playbook `Titus`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Titus/SKILL.md` with `Read`.
