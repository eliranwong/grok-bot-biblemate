...
name: 2 Timothy
description: >-
  Use when the user runs /2Tim or requests this BibleMate workflow (native Grok Bot port).
---
# 2 Timothy

Native Grok Bot port of the BibleMate playbook `2Tim`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/2Tim/SKILL.md` with `Read`.
