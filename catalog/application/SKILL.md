...
name: Application
description: >-
  Use when the user runs /application or requests this BibleMate workflow (native Grok Bot port).
---
# Application

Native Grok Bot port of the BibleMate playbook `application`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/application/SKILL.md` with `Read`.
