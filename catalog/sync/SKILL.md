...
name: Sync
description: >-
  Use when the user runs /sync or requests this BibleMate workflow (native Grok Bot port).
---
# Sync

Native Grok Bot port of the BibleMate playbook `sync`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/sync/SKILL.md` with `Read`.
