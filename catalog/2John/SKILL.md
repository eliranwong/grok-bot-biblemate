...
name: 2 John
description: >-
  Use when the user runs /2John or requests this BibleMate workflow (native Grok Bot port).
---
# 2 John

Native Grok Bot port of the BibleMate playbook `2John`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/2John/SKILL.md` with `Read`.
