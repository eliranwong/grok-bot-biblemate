...
name: Philippians
description: >-
  Use when the user runs /Phil or requests this BibleMate workflow (native Grok Bot port).
---
# Philippians

Native Grok Bot port of the BibleMate playbook `Phil`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Phil/SKILL.md` with `Read`.
