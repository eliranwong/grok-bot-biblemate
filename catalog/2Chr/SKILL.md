...
name: 2 Chronicles
description: >-
  Use when the user runs /2Chr or requests this BibleMate workflow (native Grok Bot port).
---
# 2 Chronicles

Native Grok Bot port of the BibleMate playbook `2Chr`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/2Chr/SKILL.md` with `Read`.
