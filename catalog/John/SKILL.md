...
name: John
description: >-
  Use when the user runs /John or requests this BibleMate workflow (native Grok Bot port).
---
# John

Native Grok Bot port of the BibleMate playbook `John`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/John/SKILL.md` with `Read`.
