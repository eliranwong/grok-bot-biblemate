...
name: NT Context
description: >-
  Use when the user runs /nt-context or requests this BibleMate workflow (native Grok Bot port).
---
# NT Context

Native Grok Bot port of the BibleMate playbook `nt-context`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/nt-context/SKILL.md` with `Read`.
