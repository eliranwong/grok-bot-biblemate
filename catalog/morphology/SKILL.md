...
name: Morphology
description: >-
  Use when the user runs /morphology or requests this BibleMate workflow (native Grok Bot port).
---
# Morphology

Native Grok Bot port of the BibleMate playbook `morphology`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/morphology/SKILL.md` with `Read`.
