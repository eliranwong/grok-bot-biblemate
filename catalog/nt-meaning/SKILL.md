...
name: NT Meaning
description: >-
  Use when the user runs /nt-meaning or requests this BibleMate workflow (native Grok Bot port).
---
# NT Meaning

Native Grok Bot port of the BibleMate playbook `nt-meaning`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/nt-meaning/SKILL.md` with `Read`.
