...
name: 2 Peter
description: >-
  Use when the user runs /2Pet or requests this BibleMate workflow (native Grok Bot port).
---
# 2 Peter

Native Grok Bot port of the BibleMate playbook `2Pet`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/2Pet/SKILL.md` with `Read`.
