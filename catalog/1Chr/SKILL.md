...
name: 1 Chronicles
description: >-
  Use when the user runs /1Chr or requests this BibleMate workflow (native Grok Bot port).
---
# 1 Chronicles

Native Grok Bot port of the BibleMate playbook `1Chr`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/1Chr/SKILL.md` with `Read`.
