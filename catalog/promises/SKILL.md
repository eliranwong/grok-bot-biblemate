...
name: Promises
description: >-
  Use when the user runs /promises or requests this BibleMate workflow (native Grok Bot port).
---
# Promises

Native Grok Bot port of the BibleMate playbook `promises`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/promises/SKILL.md` with `Read`.
