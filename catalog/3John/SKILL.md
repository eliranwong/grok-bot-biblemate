...
name: 3 John
description: >-
  Use when the user runs /3John or requests this BibleMate workflow (native Grok Bot port).
---
# 3 John

Native Grok Bot port of the BibleMate playbook `3John`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/3John/SKILL.md` with `Read`.
