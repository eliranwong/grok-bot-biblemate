...
name: Amos
description: >-
  Use when the user runs /Amos or requests this BibleMate workflow (native Grok Bot port).
---
# Amos

Native Grok Bot port of the BibleMate playbook `Amos`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Amos/SKILL.md` with `Read`.
