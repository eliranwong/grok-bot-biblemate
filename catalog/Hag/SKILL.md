...
name: Haggai
description: >-
  Use when the user runs /Hag or requests this BibleMate workflow (native Grok Bot port).
---
# Haggai

Native Grok Bot port of the BibleMate playbook `Hag`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Hag/SKILL.md` with `Read`.
