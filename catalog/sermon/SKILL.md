...
name: Sermon
description: >-
  Use when the user runs /sermon or requests this BibleMate workflow (native Grok Bot port).
---
# Sermon

Native Grok Bot port of the BibleMate playbook `sermon`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/sermon/SKILL.md` with `Read`.
