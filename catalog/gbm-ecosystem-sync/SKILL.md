...
description: >-
  Use when the user runs /gbm-ecosystem-sync or requests this BibleMate workflow (native Grok Bot port).
---
# GBM Ecosystem Sync

Native Grok Bot port of the BibleMate playbook `gbm-ecosystem-sync`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/gbm-ecosystem-sync/SKILL.md` with `Read`.
