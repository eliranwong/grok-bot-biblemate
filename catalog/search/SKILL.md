...
name: Search
description: >-
  Use when the user runs /search or requests this BibleMate workflow (native Grok Bot port).
---
# Search

Native Grok Bot port of the BibleMate playbook `search`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/search/SKILL.md` with `Read`.
