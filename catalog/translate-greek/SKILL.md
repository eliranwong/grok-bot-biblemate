...
description: >-
  Use when the user runs /translate-greek or requests this BibleMate workflow (native Grok Bot port).
---
# Translate Greek

Native Grok Bot port of the BibleMate playbook `translate-greek`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/translate-greek/SKILL.md` with `Read`.
