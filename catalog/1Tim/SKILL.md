...
name: 1 Timothy
description: >-
  Use when the user runs /1Tim or requests this BibleMate workflow (native Grok Bot port).
---
# 1 Timothy

Native Grok Bot port of the BibleMate playbook `1Tim`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/1Tim/SKILL.md` with `Read`.
