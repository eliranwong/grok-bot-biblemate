...
name: Chronology
description: >-
  Use when the user runs /chronology or requests this BibleMate workflow (native Grok Bot port).
---
# Chronology

Native Grok Bot port of the BibleMate playbook `chronology`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/chronology/SKILL.md` with `Read`.
