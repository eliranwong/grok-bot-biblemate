...
name: NT Themes
description: >-
  Use when the user runs /nt-themes or requests this BibleMate workflow (native Grok Bot port).
---
# NT Themes

Native Grok Bot port of the BibleMate playbook `nt-themes`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/nt-themes/SKILL.md` with `Read`.
