...
name: Psalms
description: >-
  Use when the user runs /Ps or requests this BibleMate workflow (native Grok Bot port).
---
# Psalms

Native Grok Bot port of the BibleMate playbook `Ps`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Ps/SKILL.md` with `Read`.
