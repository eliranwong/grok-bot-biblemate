...
name: Esther
description: >-
  Use when the user runs /Esth or requests this BibleMate workflow (native Grok Bot port).
---
# Esther

Native Grok Bot port of the BibleMate playbook `Esth`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Esth/SKILL.md` with `Read`.
