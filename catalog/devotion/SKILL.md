...
name: Devotion
description: >-
  Use when the user runs /devotion or requests this BibleMate workflow (native Grok Bot port).
---
# Devotion

Native Grok Bot port of the BibleMate playbook `devotion`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/devotion/SKILL.md` with `Read`.
