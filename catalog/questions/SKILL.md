...
name: Questions
description: >-
  Use when the user runs /questions or requests this BibleMate workflow (native Grok Bot port).
---
# Questions

Native Grok Bot port of the BibleMate playbook `questions`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/questions/SKILL.md` with `Read`.
