...
name: Matthew
description: >-
  Use when the user runs /Matt or requests this BibleMate workflow (native Grok Bot port).
---
# Matthew

Native Grok Bot port of the BibleMate playbook `Matt`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Matt/SKILL.md` with `Read`.
