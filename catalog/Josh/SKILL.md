...
name: Joshua
description: >-
  Use when the user runs /Josh or requests this BibleMate workflow (native Grok Bot port).
---
# Joshua

Native Grok Bot port of the BibleMate playbook `Josh`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Josh/SKILL.md` with `Read`.
