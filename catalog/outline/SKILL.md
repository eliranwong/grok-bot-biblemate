...
name: Outline
description: >-
  Use when the user runs /outline or requests this BibleMate workflow (native Grok Bot port).
---
# Outline

Native Grok Bot port of the BibleMate playbook `outline`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/outline/SKILL.md` with `Read`.
