...
name: Zechariah
description: >-
  Use when the user runs /Zech or requests this BibleMate workflow (native Grok Bot port).
---
# Zechariah

Native Grok Bot port of the BibleMate playbook `Zech`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Zech/SKILL.md` with `Read`.
