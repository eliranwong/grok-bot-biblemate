...
name: Themes
description: >-
  Use when the user runs /themes or requests this BibleMate workflow (native Grok Bot port).
---
# Themes

Native Grok Bot port of the BibleMate playbook `themes`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/themes/SKILL.md` with `Read`.
