...
name: Locations
description: >-
  Use when the user runs /locations or requests this BibleMate workflow (native Grok Bot port).
---
# Locations

Native Grok Bot port of the BibleMate playbook `locations`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/locations/SKILL.md` with `Read`.
