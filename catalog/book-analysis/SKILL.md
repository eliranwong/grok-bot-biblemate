...
name: Book Analysis
description: >-
  Use when the user runs /book-analysis or requests this BibleMate workflow (native Grok Bot port).
---
# Book Analysis

Native Grok Bot port of the BibleMate playbook `book-analysis`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/book-analysis/SKILL.md` with `Read`.
