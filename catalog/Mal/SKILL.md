...
name: Malachi
description: >-
  Use when the user runs /Mal or requests this BibleMate workflow (native Grok Bot port).
---
# Malachi

Native Grok Bot port of the BibleMate playbook `Mal`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Mal/SKILL.md` with `Read`.
