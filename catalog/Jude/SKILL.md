...
name: Jude
description: >-
  Use when the user runs /Jude or requests this BibleMate workflow (native Grok Bot port).
---
# Jude

Native Grok Bot port of the BibleMate playbook `Jude`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Jude/SKILL.md` with `Read`.
