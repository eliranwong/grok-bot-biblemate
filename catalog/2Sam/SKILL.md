...
name: 2 Samuel
description: >-
  Use when the user runs /2Sam or requests this BibleMate workflow (native Grok Bot port).
---
# 2 Samuel

Native Grok Bot port of the BibleMate playbook `2Sam`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/2Sam/SKILL.md` with `Read`.
