...
name: Galatians
description: >-
  Use when the user runs /Gal or requests this BibleMate workflow (native Grok Bot port).
---
# Galatians

Native Grok Bot port of the BibleMate playbook `Gal`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Gal/SKILL.md` with `Read`.
