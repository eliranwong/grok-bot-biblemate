...
name: Characters
description: >-
  Use when the user runs /characters or requests this BibleMate workflow (native Grok Bot port).
---
# Characters

Native Grok Bot port of the BibleMate playbook `characters`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/characters/SKILL.md` with `Read`.
