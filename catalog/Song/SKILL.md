...
name: Song of Songs
description: >-
  Use when the user runs /Song or requests this BibleMate workflow (native Grok Bot port).
---
# Song of Songs

Native Grok Bot port of the BibleMate playbook `Song`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/Song/SKILL.md` with `Read`.
