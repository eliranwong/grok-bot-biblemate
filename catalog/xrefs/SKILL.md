...
name: Xrefs
description: >-
  Use when the user runs /xrefs or requests this BibleMate workflow (native Grok Bot port).
---
# Xrefs

Native Grok Bot port of the BibleMate playbook `xrefs`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/xrefs/SKILL.md` with `Read`.
