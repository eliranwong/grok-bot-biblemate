...
name: Theology
description: >-
  Use when the user runs /theology or requests this BibleMate workflow (native Grok Bot port).
---
# Theology

Native Grok Bot port of the BibleMate playbook `theology`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/theology/SKILL.md` with `Read`.
