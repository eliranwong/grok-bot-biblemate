...
name: Perspective
description: >-
  Use when the user runs /perspective or requests this BibleMate workflow (native Grok Bot port).
---
# Perspective

Native Grok Bot port of the BibleMate playbook `perspective`.

## Steps
1. Read the full playbook at `/home/box/agent-data/biblemate-native-skills/perspective/SKILL.md` with `Read`.
