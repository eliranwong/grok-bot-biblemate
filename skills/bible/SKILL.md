...
## Overview
This standalone skill enables any agent to retrieve and compare Bible verses directly from the local SQLite databases stored in `/workspace/biblemate/data/bibles` or `/workspace/biblemate/data_custom/bibles`.

## Guidelines & Objectives
When executing this skill:
- Always run the python retriever script located at `/home/box/agent-data/biblemate-native-skills/bible/bible_retriever.py` to retrieve the requested verses.
- Execute the script using: `python3 /home/box/agent-data/biblemate-native-skills/bible/bible_retriever.py "<query>"` where `<query>` is the input prompt or arguments.
...
Folded from the Grok Build command `/bible` — treat “user arguments after the slash command” as the input the user provided after the slash.
