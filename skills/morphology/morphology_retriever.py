...
def main():
    ...
    db_path = os.path.join((os.environ.get('BIBLEMATE_DATA') or next((p for p in ['/workspace/biblemate','/home/box/biblemate',os.path.join(os.path.expanduser('~'),'biblemate')] if os.path.isdir(p)), '/workspace/biblemate')), 'data', 'morphology.sqlite')
