...
source: .grok/skills/short-prayer
---
# Short Prayer
...
Folded from the Grok Build command `/short-prayer` — treat “user arguments after the slash command” as the input the user provided after the slash.
