...
source: .grok/skills/translate-greek
---
# Translate Greek
...
Folded from the Grok Build command `/translate-greek` — treat “user arguments after the slash command” as the input the user provided after the slash.
