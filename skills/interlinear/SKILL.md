...
source: .grok/skills/interlinear
---
# Interlinear
...
- Always run the python retriever script located at `/home/box/agent-data/biblemate-native-skills/interlinear/interlinear_retriever.py`.
- Execute the script using: `python3 /home/box/agent-data/biblemate-native-skills/interlinear/interlinear_retriever.py "<query>"` where `<query>` is the user input or scripture reference.
...
Folded from the Grok Build command `/interlinear` — treat “user arguments after the slash command” as the input the user provided after the slash.
