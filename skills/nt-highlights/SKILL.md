...
source: .grok/skills/nt-highlights
---
# NT Highlights
...
Folded from the Grok Build command `/nt-highlights` — treat “user arguments after the slash command” as the input the user provided after the slash.

Adopt the **NT Bible Scholar** persona from `/workspace/biblemate-agentic-workspace/.grok/agents.md`.
