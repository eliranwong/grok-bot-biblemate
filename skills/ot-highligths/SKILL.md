...
source: .grok/skills/ot-highligths
---
...
Folded from the Grok Build command `/ot-highligths` — treat “user arguments after the slash command” as the input the user provided after the slash.
