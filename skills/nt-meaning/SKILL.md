...
Folded from the Grok Build command `/nt-meaning` — treat “user arguments after the slash command” as the input the user provided after the slash.
