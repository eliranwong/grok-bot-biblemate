...
source: .grok/skills/perspective
---
# Perspective
...
Folded from the Grok Build command `/perspective` — treat “user arguments after the slash command” as the input the user provided after the slash.
